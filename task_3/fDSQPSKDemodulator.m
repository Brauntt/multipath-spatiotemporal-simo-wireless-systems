function [bitsOut] = fDSQPSKDemodulator(symbolsOut, weightSr, goldSeq, phi, delayEst, nPaths, fadingCoefs)
% Function:
%   - perform demodulation of the received data
%
% InputArg(s):
%   - symbolsOut: channel symbol chips received from each antenna
%   - weightSr: the weight of the superresolution beamformer
...
symbolsOut = symbolsOut * conj(weightSr);
